 ...
 * @property {boolean} [randomText=false] bot random Text choose.
 * @property {boolean} [discord=false] discord.js package require.
 * @property {boolean} [client=false] discord.js client.
 * @property {boolean} [argsCheck=false] check message args.
 * @property {boolean} [format=false] format Ms to Time.
 * @property {boolean} [convertMs=false] Ms to Time concerter.
 * @property {boolean} [addOwner=false] add new Owner Id.
 * @property {boolean} [Customcommand=false] besic Custom Command create.
 * @property {boolean} [guildadd=false] bot join new guild information send channel.
 * @property {boolean} [guildremove=false] bot leave guild information send channel.
